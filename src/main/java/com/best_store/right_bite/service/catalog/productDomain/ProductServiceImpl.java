...
import com.best_store.right_bite.exception.messageProvider.ProductExceptionMP;
...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductDTO getProductDTOById(Long id) {
        return productEntityToDTOMapper.toDTO(catalogRepository.findById(id)
                .orElseThrow(() -> new ProductNotFoundException(ProductExceptionMP.ID_PRODUCT_NOT_FOUND.formatted(id))));
    }
